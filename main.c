...
int cpu_step(void) {
    ...
    switch (op) {
        ...
        case 0x06: // LD B, <n8>        c=8, b=2, flags=none
            ...
            PC += 2;
            return 8;
        case 0x08: // LD [a16],SP b3 c20 flags=none
        ...
        case 0x1C: // INC E  c=4 b=1 flags Z=Z, N=0, H=H, C=-
            ...
            PC += 1;
            return 4;
        case 0x1D:  // DEC E    c=4, b=1, flags= Z=Z N=1 H=H C=-
        ...
        case 0x24:  // INC H  b-1 c=4 flags=Z0H- 
            ...
            PC += 1;
            return 4;
        case 0x25:  // DEC H    c=4, b=1, flags= Z=Z N=1 H=H C=-
            ...
            PC += 1;
            return 4;
        case 0x26: // LD H, <n8>        c=8, b=2, flags=none
            H = rom[PC + 1];
        ...
        case 0x28: // JR Z, <e8> c=[12,8] b=2
            ...
            return 12; 
        case 0x29: // ADD HL, HL   b=1 c=8, flags=-0HC
        ...
        case 0x2D:  // DEC L    c=4, b=1, flags= Z=Z N=1 H=H C=-
            ...
            PC += 1;
            return 4;
        case 0x2E: // LD L, <n8> c=8, b=2, flags= none 
            L = rom[PC + 1];
        ...
        case 0x33: // INC SP b=1 c=8 flags = none
        ...
        case 0x36: // LD [HL], <n8>  c=12, b=2 flags=none
            ...
            PC += 2;
            return 12;
        case 0x38: //JR C, <e8> c=12,8 b=2 flags=none (signed relative offset 8 bit)
            e8 = (int8_t)rom[PC + 1];
            ...
            return 12; 
        case 0x39: // ADD HL, SP   b=1 c=8, flags=-0HC
            ...
            PC += 1;
            return 8;
        case 0x3B: // DEC SP  c=8, b=1, flags=none
            if (debug) printf("DEC SP\n");
            SP--;
            PC += 1;
            return 8;
        case 0x3C: // INC A  c=4 b=1 flags: Z=Z N=0 H=H C=-
        ...
        case 0x4E: //LD C, [HL] b=1 c=8 flags=none
            ...
            PC += 1;
            return 8;
        case 0x4F: //LD C, A  b=1, c=4 flags=none
        ...
        case 0x56: //LD D, [HL] b=1 c=8 flags=none
            ...
            PC += 1;
            return 8;
        case 0x57: //LD D, A  b=1, c=4 flags=none
            if (debug) printf("LD D, A\n");
            D = A;
            PC += 1;
            return 4;
        case 0x5D: //LD E, L  c=4 b=1 flags=none
            if (debug) printf("LD E, L\n");
            E = A;
            PC += 1;
            return 4;
        case 0x5E: //LD E, [HL] b1 c8 flags=none
            if (debug) printf("LD E, [HL]\n");
            E = rom[HL];
            PC += 1;
            return 8;
        case 0x5F: //LD E, A b1 c4
            if (debug) printf("LD E, A\n");
            E = A;
            PC += 1;
            return 4;
        case 0x62: // LD H, D b = 1, c=4, flags=none
            if (debug) printf("LD H, D\n");
            H = D;
            PC += 1;
            return 4;
        case 0x66: //LD H, [HL] b1 c8 flags=none
            if (debug) printf("LD H, [HL]\n");
            H = rom[HL];
            PC += 1;
            return 8;
        case 0x67: //LD H, A  c=4 b=1 flags=none
            if (debug) printf("LD H, A\n");
            H = A;
            PC += 1;
            return 4;
        case 0x6B: // LD L, E b = 1, c=4, flags=none
        ...
        case 0x6E: //LD L, [HL] b1 c8 flags=none
            ...
            PC += 1;
            return 8;
        case 0x6F: //LD L, A  c=4 b=1 flags=none
            if (debug) printf("LD L, A\n");
            L = A;
            PC += 1;
            return 8;
        case 0x70: // LD [HL], B   c=8, b=1 flags=none
            if (debug) printf("LD [HL], B\n");
            mem_write8(L | (H << 8), B); 
            PC += 1;
            return 8;
        case 0x71: // LD [HL], C   c=8, b=1 flags=none
            if (debug) printf("LD [HL], C\n");
            mem_write8(L | (H << 8), C); 
            PC += 1;
            return 8;
        case 0x72: // LD [HL], D   c=8, b=1 flags=none
            if (debug) printf("LD [HL], D\n");
            mem_write8(L | (H << 8), D); 
            PC += 1;
            return 8;
        case 0x73: // LD [HL], E   c=8, b=1 flags=none
            if (debug) printf("LD [HL], E\n");
            mem_write8(L | (H << 8), E); 
            PC += 1;
            return 8;
        case 0x76: // HALT  b=1 c=4 flags=none
        ...
        case 0x78: //LD A, B  b=1, c=4 flags=none
            ...
            PC += 1;
            return 4;
        case 0x79: //LD A, C  b=1, c=4 flags=none
            if (debug) printf("LD A, C\n");
            A = C;
            PC += 1;
            return 4;
        case 0x7A: //LD A, D  b=1, c=4 flags=none
            if (debug) printf("LD A, D\n");
            A = D;
            PC += 1;
            return 4;
        case 0x7B: //LD A, E  b=1, c=4 flags=none
        ...
        case 0x7D: // LD A, L b = 1, c=4, flags=none
            ...
            PC += 1;
            return 4;
        case 0x7E: //LD A, [HL] b=1 c=8 flags=none
            if (debug) printf("LD A, [HL]\n");
            A = rom[HL];
            PC += 1;
            return 8;
        case 0xA9: // XOR A, C b=1 c=4 flags=Z000
            ...
            PC += 1;
            return 4;
        case 0xAD: // XOR A, L b=1 c=4 flags=Z000
        ...
        case 0xB7: // OR A, A
            ...
            PC += 1;
            return 4;
        case 0xB8: // CP A, B  c=4, b=1 flags=Z=Z, N=1, H=H, C=C
        ...
        case 0xD0: //RET NC b=1 c[20, 8] flags=none
                   ...
                   PC += 1;
                   return 8;
        case 0xD1: // POP DE b= 1 c=12 flags none
        ...
        case 0xE6: // AND A, <n8> b=2 c=8 flags: Z010
                   ...
                   PC += 2;
                   return 8;
        case 0xE8: // ADD SP, <e8>   b=2 c=16, flags=00HC
                   e8 = (int8_t)rom[PC + 1];
                   ...
                   PC += 2;
                   return 16;
        case 0xE9: // JP HL b1 c4 flags=none
        ...
        case 0xEA: //LD [a16], A  c=16 b=3 flags=none
                   ...
                   PC += 3;
                   return 16;
        case 0xEE: // XOR A, <n8>  b2 c8 flagz:Z000
                   n8 = rom[PC + 1];
        ...
        case 0xF1: // POP AF
                   if (debug) printf("POP AF\n");
                   {
                       ...
                       F = low2 & 0xF0;
                       A = high2;
                       //printf("After POP AF: F=0x%02X (lower nibble = 0x%X)\n", F, F & 0x0F);
                   }
                   PC += 1;
                   return 12;
        ...
        case 0xF5: // PUSH AF
                   ...
                   //printf("PUSH AF: SP=0x%04X, pushing A=0x%02X, F=0x%02X\n", SP, A, F & 0xF0);
                   SP -= 2;
                   mem_write16(SP, AF);
                   PC += 1;
                   return 16;
        case 0xF8: // LD HL, SP+e8  b=2 c=12 flags=00HC
                   e8 = (int8_t)rom[PC + 1];
        ...
        case 0xFA:  //LD A, [<a16>] b=3 c=16 flags=none
                   ...
                   PC += 3;
                   return 16;
        case 0xFB: // EI  b=1 c=4 flags=none
                   if (debug) printf("EI\n");
                   ime_scheduled = true;
                   PC += 1;
                   return 4;
